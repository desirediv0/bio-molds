...
export default function Footer() {
  return (
    <footer className="bg-[#182739] text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-14">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 text-sm mt-4 max-w-xs leading-relaxed">
            ...
            <div className="flex gap-3 mt-6">
              <a href="#" className="w-9 h-9 rounded-lg bg-[#243447] hover:bg-cyan-500 flex items-center justify-center transition-colors">
          ...
          {/* Col 2 */}
          <div>
            <h4 className="text-xs tracking-widest text-slate-400 uppercase mb-5 font-bold">Services</h4>
          ...
          {/* Col 3 */}
          <div>
            <h4 className="text-xs tracking-widest text-slate-400 uppercase mb-5 font-bold">Company</h4>
            <ul className="flex flex-col gap-3 text-sm text-gray-300">
          ...
          {/* Col 4 */}
          <div>
            <h4 className="text-xs tracking-widest text-slate-400 uppercase mb-5 font-bold">Contact</h4>
            <ul className="flex flex-col gap-4 text-sm text-gray-400">
              ...
              <li className="flex gap-3 items-center">
                ...
                <span>+91 9315465339 / 8076704954</span>
              </li>
              <li className="flex gap-3 items-center">
                <span className="text-cyan-400">☎️</span>
                <span>+91 11 4562 0653</span>
              </li>
              <li className="flex gap-3 items-center">
                <span className="text-cyan-400">✉️</span>
