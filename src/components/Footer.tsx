...
export default function Footer() {
  return (
    <footer className="bg-[#0a2e2e] text-white pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-14">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3 mt-6">
              <a href="#" className="w-9 h-9 rounded-lg bg-[#0d3d3d] hover:bg-cyan-600 flex items-center justify-center transition-colors">
